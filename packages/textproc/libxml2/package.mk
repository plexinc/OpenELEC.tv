...
PKG_BUILD_DEPENDS_TARGET="toolchain $ICONV zlib"
PKG_BUILD_DEPENDS_HOST="ccache:host zlib:host Python-host"
...
if [ "$ICONV" = "libiconv" ]; then
  PKG_CONFIGURE_OPTS_TARGET="$PKG_CONFIGURE_OPTS_TARGET --with-iconv"
fi
