...
PKG_DEPENDS="atvclient ffmpeg Python zlib bzip2 systemd libass curl rtmpdump fontconfig freetype libmad libogg libmodplug faad2 flac libmpeg2 taglib service.openelec.settings SDL_mixer SDL_image"
