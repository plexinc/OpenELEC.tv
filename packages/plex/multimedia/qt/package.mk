...
case $PROJECT in
	...
	;;
	RPi|RPi2)
		PKG_DEPENDS_TARGET="curl bcm2835-driver bzip2 Python zlib:host zlib libpng tiff dbus glib fontconfig glibc alsa flex bison ruby libX11 xrandr libXdmcp libxslt libXcomposite libwebp libevdev libxkbcommon libdrm libXi atk"
