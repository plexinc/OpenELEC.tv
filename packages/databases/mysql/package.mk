...
PKG_BUILD_DEPENDS_TARGET="toolchain zlib ncurses"
...
PKG_CONFIGURE_OPTS_HOST="--localstatedir=/var/mysql --with-zlib-dir=$ROOT/$TOOLCHAIN"

pre_build_target() {
  # MYSQL needs to be build for HOST first
    $SCRIPTS/build mysql:host
}
